...
void * double_release_001_tsk_001 (void * pram)
{
    ...
    pthread_mutex_unlock (double_release_001_glb_mutex); /*Tool should detect this line as error*/ /*ERROR:Double UnLock*/
    return NULL;
}
...
void * double_release_003_tsk_001 (void * pram)
{
	...
	double_release_003_func_001 ();
	pthread_mutex_unlock (double_release_003_glb_mutex); /*Tool should detect this line as error*/ /*ERROR:Double UnLock*/
	return NULL;
}
...
void * double_release_004_tsk_001 (void * pram)
{
	...
	for(i=0;i<2;i++)
	{
		...
		pthread_mutex_unlock (double_release_004_glb_mutex);
	}
	pthread_mutex_unlock (double_release_004_glb_mutex);/*Tool should detect this line as error*/ /*ERROR:Double UnLock*/
    return NULL;
}
...
void * double_release_005_tsk_001 (void * pram)
{
	...
	for(i=0;i<2;i++)
	{
		pthread_mutex_unlock (double_release_005_glb_mutex); /*Tool should detect this line as error*/ /*ERROR:Double UnLock*/
	}
	return NULL;
}
