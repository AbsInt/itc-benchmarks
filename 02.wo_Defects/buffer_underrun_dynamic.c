...
void dynamic_buffer_underrun_031()
{
	...
	if(ptr1!=NULL)
	{
	    ...
	    for(i=10;i>-1;i--)
	    {
	        ptr1[i]='a';/*Tool should Not detect this line as error*/ /*No ERROR:Buffer Underrun*/
	    }
	    memcpy(ptr2,ptr1,12);
	    free(ptr1);
	}
...
void dynamic_buffer_underrun_036()
{
	  ...
	  if(newTest!=NULL)
	  {
	     ...
	     char c ;
	     c = newTest[10];/*Tool should Not detect this line as error*/ /*No ERROR:Buffer Underrun*/
	     free(newTest);
	  }
 }
